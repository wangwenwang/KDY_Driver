//
//  NetWorkBaseBiz.swift
//  newDriver
//
//  Created by 凯东源 on 16/11/17.
//  Copyright © 2016年 凯东源. All rights reserved.
//

import UIKit

class NetWorkBaseBiz: NSObject {
    ...
    // MARK:- post请求
    open func postWithPath(path: String,paras: Dictionary<String,Any>?,success: @escaping ((_ result: Any) -> ()),failure: @escaping ((_ error: Error) -> ())) {
        var i = 0
        var address: String = ""
        if let paras = paras {
            for (key,value) in paras {
